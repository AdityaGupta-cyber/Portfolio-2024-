<template>
    <section class="min-h-screen w-full" ref="experienceSection" id="experience-section">
        ...
        <div :class="['flex flex-col  space-y-4 lg:grid lg:grid-cols-2 lg:gap-x-4 lg:space-y-2 mb-36 transition-all motion-reduce:transition-none duration-500 delay-300', visible ? 'translate-y-0 opacity-1 blur-0' : 'translate-y-4 opacity-0 blur-sm']">
            <ExperienceCard
